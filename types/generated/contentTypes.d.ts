...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    main_title: Schema.Attribute.Component<'shared.fading-title', false>;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'shared.home-about-us', true>;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    cards: Schema.Attribute.Component<'shared.home-card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    events: Schema.Attribute.Relation<'oneToMany', 'api::event.event'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    space: Schema.Attribute.Media<'images', true>;
    terms: Schema.Attribute.Component<'shared.terms-and-conditions', false>;
...
export interface ApiProductEmailProductEmail
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_emails';
  info: {
    displayName: 'ProductEmail';
    pluralName: 'product-emails';
    singularName: 'product-email';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-email.product-email'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::product-email.product-email': ApiProductEmailProductEmail;
